          ...
          <>
               <div className="h-screen flex flex-col justify-center items-center">
                    <div className="h-4/5 w-[284px] flex flex-col items-center text-2xl">
                         <h1 className="font-normal text-2xl text-primary-default">Sign Up</h1>
                         <form noValidate className="w-full h-full flex flex-col items-center justify-evenly font-Bayon">

                              <div className="w-full flex flex-col gap-5">
                                   <input type="text" name="first_name" required autoComplete="none" placeholder="user name"
                              ...
                              <div className="flex flex-col w-full gap-6">
                                   ...
                                   <p className="text-white text-base font-normal text-center mt-3">Already Have an account?<Link to="/login" className="text-primary-default"> login</Link></p>
                              </div>
                         </form>
                    </div >
               </div >
