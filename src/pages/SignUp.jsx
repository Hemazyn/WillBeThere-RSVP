...
const SignUp = () => {
    ...
    const handleSignUp = (e) => {
        e.preventDefault();
        axios.post("https://will-be-there-auth-server.onrender.com/api/register/", {
                            ...
                            <div className="px-5 flex flex-col gap-5 md:gap-10">
                                ...
                                <div className="w-full flex flex-col font-Bayon gap-5 md:gap-8">
                                    ...
                                    <div className="flex flex-col gap-3 md:gap-5">
                                        <TextInput type="password" name="password" placeholder="enter password" required={true} onInvalid={(e) => e.target.setCustomValidity("Password must be at least 6 characters long.")} onInput={handleChange} />
                                    </div>
                                </div>
                            </div>
