                              ...
                              <form noValidate className="flex flex-col gap-5 md:gap-10">
                                   ...
                                   <div className="flex flex-col w-full items-center gap-5 md:gap-10 px-5">
                                        <div className="flex flex-row font-Bayon gap-[60px]">
                                             <Link to="">
                                                  <svg className="w-[40px] h-[40px] md:w-[60px] md:h-[60px]" viewBox="0 0 60 60" fill="white" xmlns="http://www.w3.org/2000/svg">
                                                       <g>
                                        ...
                                        <button type="submit" className="w-full  bg-primary-light uppercase font-Bayon font-normal text-base rounded-[10px] py-2 md:py-4">Continue</button>
                                   </div>
                              </form>
                         </div>
