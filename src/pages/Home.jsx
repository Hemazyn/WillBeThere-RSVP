      ...
      <div className="h-screen flex flex-col justify-center items-center font-Bayon">
        <div className="h-4/5 md:h-3/5 flex flex-col justify-between">
          ...
          <div className="flex flex-col items-center gap-10">
            <Link to="/auth/login"><button type="button" className="h-[49px] w-[105px] bg-white rounded-[10px]">Continue</button></Link>
            <p className="text-white">Already Have an account?<Link to="/auth/login" className="text-primary-default"> login</Link></p>
          </div>
        </div>
      </div >
    </>
