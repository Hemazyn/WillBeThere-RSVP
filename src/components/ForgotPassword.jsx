               ...
               <div className="h-screen flex flex-row">
                    <div className="h-full w-full md:w-md1 flex justify-center items-center">
                         ...
                         <div className="h-4/5 w-full lg:w-md2 flex flex-col">
                              {showMailCheck ? (
                                   <form noValidate className="h-full flex flex-col justify-between px-5">
                                        ...
                                        <button type="button" onClick={handleContinue} className="w-full bg-primary-light uppercase font-Bayon font-normal text-base rounded-10 py-2 md:py-4 mb-10">Continue</button>
                                   </form>
                              ) : (
                                   <MailCheck />
                              )}
